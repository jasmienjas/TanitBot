...
2. توثيق المصادر والمراجع:
   ...
   - استخدم هذه الصيغة بدقة للتصنيف والتوثيق: [المصدر: اسم_الملف. صفحة X]
...
6. الإيجاز والسرعة: اجعل إجابتك موجزة ومباشرة ومختصرة لضمان سرعة توليد الإجابة ومنع انقطاع الاتصال. ركّز على النقاط الأساسية وتجنب الشروح الطويلة غير الضرورية."""
