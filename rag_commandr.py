...
4. توثيق المراجع والملفات (هام جداً):
   ...
   - تنبيه حاسم جداً: "اسم_المصدر" هو القيمة المكتوبة بجانب كلمة "المصدر:" في السياق المرفق حرفياً وبشكل كامل دون أي تغيير أو اختصار (مثال: يجب أن تكتب [المصدر: دراسة الكريديف حول واقع النصوص القانونية والعنف الرقمي - أنوار منصري (2021)، صفحة 44]، ويمنع منعاً باتاً اختصاره إلى "منصري" أو "الحاج" أو "سيكديف" أو أي كلمة مختصرة أخرى. انقل العنوان الكامل المكتوب في السياق حرفياً).
